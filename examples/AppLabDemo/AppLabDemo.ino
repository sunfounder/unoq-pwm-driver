 ...
 * them silenced the sketch. From 0.90.0 the console is the Arduino Router's
 * Monitor on LPUART1 and USART1 is free, but they stay skipped here so the demo
 * behaves the same on every core. */
